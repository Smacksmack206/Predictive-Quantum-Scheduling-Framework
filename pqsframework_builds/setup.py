...
DATA_FILES = [
    ...
    # Real Quantum-ML System (NEW - Production Ready)
    ('quantum_ml', [
...
OPTIONS = {
    ...
    'packages': [
        ...
        'cirq',            # Quantum computing (if available)
    ...
    'includes': [
        ...
        'psutil',
        'numpy',
        # Quantum ML modules (if available)
        'cirq',
        'threading',
        'dataclasses',
        'collections.deque',
    ...
    'excludes': [
        # Heavy ML frameworks (exclude only if not needed)
        'torch', 'sklearn', 'scipy', 'matplotlib',
        'pandas', 'sympy', 'networkx', 'seaborn', 'plotly',
        'tensorflow',  # Exclude standard tensorflow (we use tensorflow-macos)
    ...
    'argv_emulation': True,   # Enable argv emulation for proper startup
    'include_plugins': [],    # Include specific plugins if needed
    'dylib_excludes': [],     # Don't exclude any dynamic libraries
    ...
    'prefer_ppc': False,      # Don't prefer PowerPC
    'frameworks': [],         # Include all necessary frameworks
